...
fid=fopen('Steadystate.txt','w');  %this opens a file and then the vector components are put in  it.
fprintf(fid, '%s \n\n', t);
...
fclose(fid);
open Steadystate.txt;   %this opens a window with the info in it
